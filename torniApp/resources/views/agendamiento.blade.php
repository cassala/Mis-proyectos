...
<body class="main-layout">
   ...
   <header>
      <nav class="topnav" id="myTopnav">
         ...
         <h1>Agendamiento</h1>
         <button class="openbtn" onclick="openNav()"><img src="/css/css-agendamiento/imagenes/menu_icon.png" alt="#" />
         </button>
      </nav>
   </header>
   <div class="container-fluid bg-image">
      <div class="container-fluid recuperar">
         ...
         <div class="formulario">
            <form style="margin-top: -6%;" name="frm" id="myform" method="POST" action="{{route('citas.agendar')}}">
               @csrf
               <div class="ulpgcds-form__item">
                  <label><b>Fecha</b></label>
                  <input autocomplete="off" class="ulpgcds-datepicker ulpgcds-form__item--icon" max="9999-12-31"
                     id="fecha-datepicker-2" name="fecha" type="date" value="" placeholder="dd/mm/aaaa" required />
               ...
               <input type="tel" id="telefono" placeholder="Ingresa tu teléfono"
                  pattern="\([0-9]{3}\) [0-9]{3}[ -][0-9]{4}" name="telefono" required>
         ...
         <div class="modal-content"
            ...
            <div class="modal-header" style="height: 30%;">
               <img src="/css/css-facturacion/imagenes/wof.png"
                  style="width: 40%; height: 230%; top: 0; margin-top: -5%; margin-left: 30%;" />
               <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"
                  style="margin-right: 0%;border: none; background: none;"></button>
            </div>
            <div class="modal-body">
               <center><span id="modaltitulo" style="font-weight: 650; font-size: large; color: #F63A3D ;">ERROR.</span>
               </center>
               <center><span id="modaltexto"
                     style="font-weight: 650; font-size: large; color: #000; padding-top: 20%; padding-left: 2%;padding-right: 2%;"></span>
               </center>
            </div>
            <div class="modal-footer">
               <button type="button" id="btncerrar" aria-label="close" class="btn btn-secondary" data-dismiss="modal"
        ...
        <div class="modal-dialog" style="height: 40%;">
          <div class="modal-content"
            ...
            <div class="modal-body">
               ...
               <center><span id="modaltexto"
                   style="font-weight: 650; font-size: large; color: #000; padding-top: 20%; padding-left: 2%; padding-right: 2%;">{{session('error')}}</span>
               </center>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                 style="background-color: #F63A3D; border: none; border-radius: 10px;">Cerrar</button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="modal fade" id="campoVacioModal" tabindex="-1" aria-labelledby="campoVacioModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="height: 40%;">
          <div class="modal-content"
            ...
            <div class="modal-body">
               <center><span id="modaltitulo" style="font-weight: 650; font-size: large; color: #F63A3D ;">ÉXITO!</span>
               </center>
               <center><span id="modaltexto"
                   style="font-weight: 650; font-size: large; color: #000; padding-top: 20%; padding-left: 2%; padding-right: 2%;">{{session('exito')}}</span>
               </center>
            </div>
            <div class="modal-footer">
               <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
